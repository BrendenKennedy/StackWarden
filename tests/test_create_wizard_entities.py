...
from stacksmith.ui.wizard_entities.block import run_block_create_wizard
from stacksmith.ui.wizard_entities.profile import run_profile_create_wizard
from stacksmith.ui.wizard_entities.stack import run_stack_create_wizard
...
def test_profile_wizard_noninteractive_dry_run(monkeypatch):
    ...
    monkeypatch.setattr("stacksmith.ui.wizard_entities.profile.detect_server_hints", lambda: hints)
...
def test_stack_wizard_requires_runtime_layer(monkeypatch):
    monkeypatch.setattr("stacksmith.ui.wizard_entities.stack.list_profile_ids", lambda: [])
    monkeypatch.setattr("stacksmith.ui.wizard_entities.stack.list_block_ids", lambda: ["app_only"])
    monkeypatch.setattr(
        "stacksmith.ui.wizard_entities.stack.load_block",
