...
from stacksmith.resolvers.base_catalog import RuntimeBaseCandidate, candidates_for

if TYPE_CHECKING:
    from stacksmith.domain.models import Profile, ScoreBreakdown, StackSpec
...
def score_candidate_detailed(
    ...
    from stacksmith.domain.models import ScoreBreakdown
