"""Custom exception hierarchy for Stacksmith.
...
class StacksmithError(Exception):
    """Base exception for all Stacksmith errors."""

    exit_code: int = EXIT_GENERIC


class ProfileNotFoundError(StacksmithError):
...
class StackNotFoundError(StacksmithError):
...
class BlockNotFoundError(StacksmithError):
...
class IncompatibleStackError(StacksmithError):
...
class SchemaValidationError(StacksmithError):
...
class BuildError(StacksmithError):
...
class DriftError(StacksmithError):
