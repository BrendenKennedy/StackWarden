...
from stacksmith.catalog.models import (
...
from stacksmith.catalog.migrations import run_migrations
from stacksmith.domain.enums import ArtifactStatus
from stacksmith.domain.errors import CatalogError
from stacksmith.paths import get_catalog_path
...
class CatalogStore:
    """SQLite-backed catalog for Stacksmith artifacts."""
