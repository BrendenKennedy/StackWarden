"""Pull builder — pull a base image and apply stacksmith labels via a thin overlay.
...
if TYPE_CHECKING:
    from stacksmith.domain.models import Plan, Profile
...
def build_pull(
    ...
    """Pull the base image, then apply stacksmith labels via a thin overlay."""
    ...
    with tempfile.TemporaryDirectory(prefix="stacksmith_pull_") as tmpdir:
