...
from stacksmith.web.jobs.admission import decide_admission
from stacksmith.web.jobs.manager import JobManager
from stacksmith.web.jobs.models import JobRecord, JobStatus
...
async def get_compatibility_fix(
    ...
    from stacksmith.domain.compatibility_fix import analyze_build_failure
...
async def retry_with_fix(
    ...
    from stacksmith.domain.compatibility_fix import analyze_build_failure, apply_compatibility_fix
