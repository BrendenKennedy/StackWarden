...
def capture_manifest(
    ...
    *,
    ...
    return ResolvedManifest(
        ...
        tuple_id=plan.artifact.labels.get("stackwarden.tuple_id", ""),
        tuple_status=plan.artifact.labels.get("stackwarden.tuple_status", ""),
        tuple_mode=plan.artifact.labels.get("stackwarden.tuple_mode", ""),
