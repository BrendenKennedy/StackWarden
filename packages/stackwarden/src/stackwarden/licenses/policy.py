...
from stackwarden.domain.enums import LicenseSeverity
from stackwarden.domain.models import ArtifactComponent, StackSpec
from stackwarden.licenses.spdx import LicenseInfo, SpdxMap
...
def evaluate_sbom(
    ...
    from stackwarden.licenses.scanner import scan_sbom_licenses
